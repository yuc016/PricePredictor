...
class LSTMNetV1(nn.Module):
    def __init__(self, input_size, lstm_size, num_layers, output_size, dropout_rate):
...
class LSTMNetV2(nn.Module):
    def __init__(self, input_size, conv1_size, lstm_size, num_layers, l2_size, output_size, dropout_rate):
